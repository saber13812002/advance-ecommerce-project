                ...
                <div class="col-8">
                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">{{ trans("admin.Sub->SubCategory List")   }} <span
                                    class="badge badge-pill badge-danger"> {{ count($subsubcategory) }} </span></h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                        ...
                        <div class="box-body">
                            <div class="table-responsive">
                                ...
                                <form method="post" action="{{ route('subsubcategory.store') }}">
                                    ...
                                    <div class="form-group">
                                        <h5>{{ trans("admin.SubCategory Select")   }} <span class="text-danger">*</span>
                                        </h5>
                                        <div class="controls">
                                    ...
                                    <div class="form-group">
                                        <h5>{{ trans("admin.Sub-SubCategory English")   }} <span
                                    ...
                                    <div class="form-group">
                                        <h5>{{ trans("admin.Sub-SubCategory Hindi")   }} <span
                                                class="text-danger">*</span></h5>
                                        <div class="controls">
