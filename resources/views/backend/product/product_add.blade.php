                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="row"> <!-- start 1st row  -->
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <h5>{{ trans("admin.Brand Select") }} <span
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <h5>{{ trans("admin.SubCategory Select")   }} <span
                                                            class="text-danger">*</span></h5>
                                                    <div class="controls">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <h5>{{ trans("admin.SubSubCategory Select")   }} <span
                                                            class="text-danger">*</span></h5>
                                                    <div class="controls">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <h5>{{ trans("admin.Product Name En")   }} <span
                                                            class="text-danger">*</span></h5>
                                                    <div class="controls">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <h5>{{ trans("admin.Product Name Hin")   }} <span
                                                            class="text-danger">*</span></h5>
                                                    <div class="controls">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <h5>{{ trans("admin.Product Owner")   }} <span
                                                            class="text-danger"></span></h5>
                                                    <div class="controls">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <h5>{{ trans("admin.Product Owner Model Name")   }} <span
                                                            class="text-danger"></span></h5>
                                                    <div class="controls">
                                                        <input type="text" name="owner_model_name" class="form-control">
                                                        @error('owner_model_name')
                                                        <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <h5>{{ trans("admin.Product Owner Model ID")   }} <span
                                                            class="text-danger"></span></h5>
                                                    <div class="controls">
                                                        <input type="text" name="owner_model_id" class="form-control">
                                                        @error('owner_model_id')
                                                        <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row"> <!-- start 4th row  -->
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <h5>{{ trans("admin.Product Tags En")   }} <span
                                                            class="text-danger">*</span></h5>
                                                    <div class="controls">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <h5>{{ trans("admin.Product Tags Hin")   }} <span
                                                            class="text-danger">*</span></h5>
                                                    <div class="controls">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <h5>{{ trans("admin.Product Size En")   }} <span
                                                            class="text-danger">*</span></h5>
                                                    <div class="controls">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <h5>{{ trans("admin.Product Size Hin")   }} <span
                                                            class="text-danger">*</span></h5>
                                                    <div class="controls">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <h5>{{ trans("admin.Product Color En")   }} <span
                                                            class="text-danger">*</span></h5>
                                                    <div class="controls">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <h5>{{ trans("admin.Product Color Hin")   }} <span
                                                            class="text-danger">*</span></h5>
                                                    <div class="controls">
                                        ...
                                        <div class="row"> <!-- start 6th row  -->
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <h5>{{ trans("admin.Main Thambnail")   }} <span class="text-danger">*</span>
                                                    </h5>
                                                    <div class="controls">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <h5>{{ trans("admin.Multiple Image")   }} <span class="text-danger">*</span>
                                                    </h5>
                                                    <div class="controls">
                                        ...
                                        <div class="row"> <!-- start 7th row  -->
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <h5>{{ trans("admin.Short Description English")   }} <span
                                                            class="text-danger">*</span></h5>
                                                    <div class="controls">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <h5>{{ trans("admin.Short Description Hindi")   }} <span
                                                            class="text-danger">*</span></h5>
                                                    <div class="controls">
                                        ...
                                        <div class="row"> <!-- start 8th row  -->
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <h5>{{ trans("admin.Long Description English")   }} <span
                                                            class="text-danger">*</span></h5>
                                                    <div class="controls">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <h5>{{ trans("admin.Long Description Hindi")   }} <span
                                                            class="text-danger">*</span></h5>
                                                    <div class="controls">
                                                    ...
                                                    <div class="controls">
                                                        <fieldset>
                                                            <input type="checkbox" id="checkbox_2" name="hot_deals"
                                                                   value="1">
                                                            <label for="checkbox_2">{{ trans('site.hotdeals') }}</label>
                                                        </fieldset>
                                                        <fieldset>
                                                            <input type="checkbox" id="checkbox_3" name="featured"
                                                                   value="1">
                                                            <label for="checkbox_3">{{ trans('site.featured') }}</label>
                                                        </fieldset>
                                                    </div>
                                                </div>
                                            </div>
